/* ═══════════════════════════════════════════════════════════════════════
   ...
   CHANGE: now also forwards a client-supplied Authorization header
   upstream. Needed for Reddit's OAuth token exchange (Basic auth) and
   Bearer-token API calls — previously stripped, breaking both.
   ═══════════════════════════════════════════════════════════════════════ */
